...
public class GenEvolLogger implements EvolutionObserver<Genotipo> {
    ...
    public void printData(Genotipo gen){
        System.out.println("Valores Mejor Genotipo Fitness - VD - CO2 - CO - HC - NOx:");
        System.out.printf("%.10f\t%.5f\t%.5f\t%.5f\t%.5f\t%.5f", gen.fitness, gen.vd,gen.co2,gen.co,gen.hc,gen.nox);
    }
